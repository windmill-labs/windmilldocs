	...
	return (
		<article
			className={clsx(className, {
				'border p-2 rounded-2xl shadow-md hover:border-blue-400 hover:shadow-lg transition-all !mb-4 bg-white dark:bg-neutral-900 dark:border-neutral-700 dark:hover:border-blue-800':
					!isBlogPostPage
			})}
			itemProp="blogPost"
			itemScope
