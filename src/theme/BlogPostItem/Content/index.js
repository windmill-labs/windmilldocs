      ...
      <MDXContent>{children}</MDXContent>
			{
				...
				<div className='flex items-start bg-blue-50 rounded-md mt-12 p-4'>
					...
					<div className='text-gray-600 font-medium'>
						<a href='https://docs.windmill.dev'>Windmill</a> is an <a href='https://github.com/windmill-labs/windmill'>open-source</a> and <a href='https://docs.windmill.dev/docs/advanced/self_host/'>self-hostable</a> serverless 
