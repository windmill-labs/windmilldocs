		...
		},
		{
			...
			features: [
				...
				},
				{
					text: (
						<span>
							Priority Support 24/7  with 48h response time and automation engineer
							assistance
						</span>
					)
				}
		...
		},
		{
			...
			features: [
				...
				},
				{
					text: (
						<span>
							SLA & Priority Support 24/7  with 3h response time and automation engineer
							assistance
						</span>
					)
				},
...
const sections = [
  {
    ...
    attributes: [
      { name: 'Tax Savings', tiers: { 'Free and Open-source': true, 'Pro': true, 'Enterprise': true }, link: 'https://www.ycombinator.com/' },
      { name: 'Easy to use accounting', tiers: { 'Free and Open-source': true, 'Pro': true, 'Enterprise': true } },
      { name: 'Multi-accounts', tiers: { 'Free and Open-source': '3 accounts', 'Pro': 'Unlimited accounts', 'Enterprise': '7 accounts' } },
      { name: 'Invoicing', tiers: { 'Free and Open-source': '3 invoices', 'Pro': 'Unlimited invoices', 'Enterprise': '10 invoices' } },
      { name: 'Exclusive offers', tiers: { 'Free and Open-source': false, 'Pro': true, 'Enterprise': true } },
      { name: '6 months free advisor', tiers: { 'Free and Open-source': false, 'Pro': true, 'Enterprise': true } },
      { name: 'Mobile and web access', tiers: { 'Free and Open-source': false, 'Pro': true, 'Enterprise': false } },
    ],
  },
  {
    name: 'Other perks',
    attributes: [
      { name: '24/7 customer support', tiers: { 'Free and Open-source': true, 'Pro': true, 'Enterprise': true } },
      { name: 'Instant notifications', tiers: { 'Free and Open-source': true, 'Pro': true, 'Enterprise': true } },
      { name: 'Budgeting tools', tiers: { 'Free and Open-source': true, 'Pro': true, 'Enterprise': true } },
      { name: 'Digital receipts', tiers: { 'Free and Open-source': true, 'Pro': true, 'Enterprise': true } },
      { name: 'Pots to separate money', tiers: { 'Free and Open-source': false, 'Pro': true, 'Enterprise': true } },
      { name: 'Free bank transfers', tiers: { 'Free and Open-source': false, 'Pro': true, 'Enterprise': false } },
      { name: 'Business debit card', tiers: { 'Free and Open-source': false, 'Pro': true, 'Enterprise': false } },
    ],
  },
]
                ...
                <section aria-labelledby="mobile-comparison-heading" className="lg:hidden">
                    ...
                    <div className="mx-auto max-w-2xl space-y-16">
                        {getPricingArray().map((pricingItem) => (
                            ...
                            <p className="mt-1 text-sm leading-6 text-gray-600">{pricingItem.description}</p>
                        </div>
                                ...
                                >
                                    ...
                                    {section.attributes.map((attribute) => (
                                        ...
                                        <dd className="flex items-center justify-end sm:justify-center sm:px-4">
                                            ...
                                            <span
                                                className={pricingItem.mostPopular
                                            ...
                                            <>
                                                ...
                                                <CheckIcon className="mx-auto h-5 w-5 text-teal-600" aria-hidden="true" />
                                                ) : (
                ...
                <section aria-labelledby="comparison-heading" className="hidden lg:block">
                    ...
                    {getPricingArray().map((pricingItem) => (
                        ...
                        >
                            ...
                            <p className="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-100">{pricingItem.description}</p>
                        </div>
                        </div>
                    ))}
                    </div>
                    ...
                    {sections.map((section) => (
                        ...
                        <div className="relative -mx-8 mt-10">
                            ...
                            aria-hidden="true"
                            >
                            <div className="h-full w-full rounded-lg bg-white dark:bg-slate-300 shadow-sm" />
                            <div className="h-full w-full rounded-lg bg-white dark:bg-slate-300 shadow-sm" />
                            <div className="h-full w-full rounded-lg bg-white dark:bg-slate-300 shadow-sm" />
                            </div>
                            ...
                            {section.attributes.map((attribute, featureIdx) => (
                                ...
                                >
                                    {attribute.link ? (
                                    <a href={attribute.link} target="_blank" rel="noopener noreferrer" className="custom-link">
                                        {attribute.name}
                                    </a>
                                    ) : (
                                    attribute.name
                                    ...
                                    {getPricingArray().map((pricingItem) => (
                                        <td key={pricingItem.id} className="relative w-1/4 px-4 py-0 text-center">
