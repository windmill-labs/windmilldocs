	...
	},
	{
		...
		answer: (
			<span>
				...
				<br />
				<br />
				Seats reported to Windmill are the number of users (1 developer, or 2 operators) who are active on the platform in the last 30 days, according to the audit logs. User count is across all instances (dev, prod) but Windmill only counts once the same user.
				<br />
				<br />
