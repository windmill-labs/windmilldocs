						...
						<div>
							<div className="mt-6">
								...
								<p className="mt-4 text-lg text-gray-500">
									...
									<br /><br />
									Your <span className='font-bold'>secrets</span> are tightly permissioned, no more sending passwords as DM on slack.
									<br /><br />
									All operations are auditable thanks to the exhaustive  <span className='font-bold'>saudit logs</span>.
									<br /><br />
									Visibility of all items is personally private by default, share it with all your teams or select persons using our  <span className='font-bold'>groups' and users' granular permissions</span>.
									<br /><br />
									Windmill makes it easy to learn python and uses the best practices of software engineering from the get go, upskill your team without efforts.
								</p>
							</div>
						</div>
					</div>
