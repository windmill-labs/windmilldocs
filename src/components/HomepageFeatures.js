...
const features = [
	{
		name: (
			<div className="flex  justify-center">
				UI? Done <CheckIcon className="text-green-600 h-6" aria-hidden="true" />
			</div>
		),
			...
			<div className="relative pt-20  pb-10">
				<div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
					...
					<p className="mx-auto mt-5 max-w-prose text-xl text-gray-700">
						serverless runtime + autogenerated UI to share your app + flow builder + schedules +
						secrets + groups + permissions + OAuth integrations + ...
					</p>
					<div className="mt-40">
							...
							<div>
								<div className="mt-6">
									...
									<p className="mt-8 text-lg text-gray-500">
										Apps and their UI are automatically generated and continuously updated from your
										script parameters. Refine the UI if desired.
										<br />
										<br />
										Develop and maintain scripts from our feature-complete webeditor or use your own
										IDE and deploy from Github.
										<br />
										<br />
										<span className="font-bold">
											The generated UI makes it very simple to expose your app to non-technical
											users while requiring minimal efforts to develop and maintain. Every script
											can be a standalone app in itself or be used as a step inside a Flow.
										</span>
									</p>
								</div>
							</div>
						...
						<div className="mt-12 sm:mt-16 lg:mt-0 lg:col-span-2">
							<div className="flex flex-col p-4 lg:-ml-4 sm:pr-6 lg:px-0  lg:h-full ">
								...
								<div className="w-full lg:max-w-lg m-auto">
									<p className="text-gray-700 italic  text-sm text-center max-w-lg">
										Script parameters are parsed automatically to generate your app UI that you may
										still refine. Scripts are also transformed into no-code modules this way.
									</p>
								</div>
							</div>
						</div>
						...
						<div>
							<div className="mt-6">
								<h2 className="text-3xl font-extrabold tracking-tight text-gray-900">
									Turn scripts into shareable internal apps or complex workflows triggered by
									webhooks, a schedule, or watching for new events.
								</h2>
								<p className="mt-8 text-lg text-gray-500">
									Your team never has to worry about deploying and managing the infra of your
									internal operations.
									<br />
									<br />
									Deploy from GitHub, or write and manage your scripts directly from Windmill, or a
									mix of both, up to you.
									<br />
									<br />
									...
									<br />
									<br />
									See all past executions and keep track of operations with{' '}
									<span className="font-bold">audit logs</span> enabling you to root cause quickly
									any mishaps.
									<br />
									<br />
									Define visibility, edit rights and executability for your scripts, resources,
									schedules, etc using{' '}
									<span className="font-bold">groups' and users' granular permissions</span>.
									<br />
									<br />
									Upskill your less technical members interested in authoring scripts themselves by
									having them learn Python or Typescript in an accessible and integrated
									environment.
								</p>
							</div>
						</div>
