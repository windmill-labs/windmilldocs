					...
					<div className="px-4 max-w-xl m-auto sm:px-6 lg:pb-16 lg:max-w-none lg:col-span-2 lg:mx-0 lg:px-0">
						<div>
							<div className="mt-2">
								...
								<p className="mt-4 text-lg text-gray-500">
									Not just for developers, the generated Apps are meant to be used by all, and the included powerful Webeditor with previews allow for powerful quick feedback loops.
									<br /><br />
