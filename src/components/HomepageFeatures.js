...
const features = [
	{
		...
		description: <span>UI is autogenerated by inferring it from your scripts parameters or flow inputs.</span >,
	...
	},
	{
		...
		description: <span>Credentials are tightly permissioned to users and groups. Ask approvals as a step of your flow.</span>,
		icon: LockClosedIcon,
	},
	{
			...
			<div className="relative pt-40  pb-10">
				<div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
					...
					<p className="mx-auto mt-5 max-w-prose text-xl text-gray-700">
						serverless runtime + autogenerated UI to share your app + flow builder + schedules + secrets + permissioning + OAuth integrations + ...
					</p>
					<div className="mt-12">
