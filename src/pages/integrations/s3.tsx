		...
		description: (
			<div className="flex flex-col gap-4">
				<p>
					...
					is a scalable, high-speed, web-based cloud storage service designed for online backup and
					archiving of data and application programs.
				</p>
				<p>
					Windmill comes with a{' '}
					<a href="/docs/core_concepts/persistent_storage/large_data_files">
						<strong>
							<span style={{ color: '##3b82f6' }}>
								native integration with S3, Azure Blob and Google Cloud Storage
							</span>
						</strong>
					</a>{' '}
					to store large objects like files & binary data and use them in your scripts, flows and
					data pipelines.
				</p>
				<p>
					You can also interact with S3 from scripts supported in multiple languages, build UIs and
					flows that you can monitor and trigger on demand, by schedule or webhooks.
				</p>
			</div>
		),
		...
		hubIntegrations: [
			{
				...
				description:
					'Use Windmill embedded workspace object storage integration to read a S3 file and explore bucket directly within script.',
				icon: Eye
			},
			{
				title: 'Create file',
				...
				description:
					'Create a file in S3 and explore bucket thans to Windmill workspace object storage.',
				icon: PlusCircle
			},
			{
