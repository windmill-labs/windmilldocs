...
import { ArrowRight, Bot, Wrench, Eye, MessageSquare, Plug, Settings, Database, BookOpen, Zap, Container, HardDrive, Cpu, Lock, Code2, Terminal, FileCode, Play, Sparkles } from 'lucide-react';
...
export const agentFeatures = [
	{ icon: Bot, title: 'DAG workflow', desc: <span>Build AI agents using Windmill's <Link to="/docs/flows/flow_editor" className="text-blue-600 dark:text-blue-400 hover:underline">workflow engine</Link>. Incorporate an AI in specific steps of your workflow — the agent reasons, picks <Link to="/docs/core_concepts/ai_agents#script-tools" className="text-blue-600 dark:text-blue-400 hover:underline">tools</Link> and executes them, while the rest of the flow handles data fetching, branching, <Link to="/docs/flows/flow_approval" className="text-blue-600 dark:text-blue-400 hover:underline">approvals</Link> and error handling.</span>, image: 'dag', docLink: '/docs/flows/flow_editor' },
	...
	{ icon: Code2, title: 'Local dev experience', desc: 'Define agent behavior with agents.md and skills. Develop and test agents locally, then deploy to Windmill workers. Same config works in development and production.', image: null, docLink: '/docs/core_concepts/ai_agents' },
	{ icon: Database, title: 'Any LLM provider', desc: <span>Switch providers or models without changing your agent logic. API keys are stored as <Link to="/docs/core_concepts/resources_and_types" className="text-blue-600 dark:text-blue-400 hover:underline">resources</Link> and reused across flows. Supports OpenAI, Anthropic, Mistral, Google Gemini, OpenRouter and custom endpoints.</span>, image: null, docLink: '/docs/core_concepts/ai_agents' },
];
				...
				<div className="p-8 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 relative overflow-hidden">
					{agentFeatures.map((feat, i) => (
						...
						>
							...
							{feat.image === 'dag' ? (
								<img src={require('./ai-agent-dag.png').default} alt="Windmill flow DAG with an AI agent step" className="rounded-lg border border-gray-200 dark:border-gray-700 w-full" />
							) : feat.image ? (
...
export function AgentModeTabs() {
	...
	const tabs = [
		{ icon: Bot, label: 'AI agents as workflow steps' },
		{ icon: Code2, label: 'Claude Code in sandbox' },
	];
	return (
		<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-24 pb-8">
			...
			{/* Tab 1: AI agents as workflow steps */}
			{activeTab === 0 && (
				<AgentFeaturesSection />
			)}

			{/* Tab 2: Claude Code in sandbox */}
			{activeTab === 1 && (
				<div>
					<div className="mb-16">
						<div className="flex items-center gap-3 mb-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
						{[
							...
							<div key={item.title} className="p-6 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950">
			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
				...
				<motion.div {...fadeIn}>
					<div className="flex flex-wrap gap-4">
						{[
							{ name: 'OpenAI', logo: '/third_party_logos/openai.svg' },
							{ name: 'Anthropic', logo: '/third_party_logos/anthropic.svg' },
							{ name: 'Google Gemini', logo: '/third_party_logos/gemini.svg' },
							{ name: 'Mistral', logo: '/third_party_logos/mistral.svg' },
							{ name: 'OpenRouter', logo: '/third_party_logos/openrouter.svg' },
						].map((provider) => (
							<div key={provider.name} className="flex items-center gap-2.5 px-4 py-2.5 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
