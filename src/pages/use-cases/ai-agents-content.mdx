...
export function AgentModeTabs() {
	...
	const tabs = [
		{ icon: Zap, label: 'Visual AI builder' },
		{ icon: Terminal, label: 'Claude / Codex / Opencode (Coming soon)' },
	];
	return (
		<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-8">
			...
			{/* Tab 1: Visual AI builder */}
			{activeTab === 0 && (
				<TabFeatureSection
					title="Visual AI builder with tools"
					subtitle={<>Build AI agents as loops with tools using Windmill's visual builder. The agent reasons, picks <Link to="/docs/core_concepts/ai_agents#script-tools" className="text-blue-600 dark:text-blue-400 hover:underline">tools</Link> (scripts or <Link to="/docs/core_concepts/mcp" className="text-blue-600 dark:text-blue-400 hover:underline">MCP servers</Link>) and executes them. Use agent steps in any <Link to="/docs/flows/flow_editor" className="text-blue-600 dark:text-blue-400 hover:underline">flow</Link> alongside branching, <Link to="/docs/flows/flow_approval" className="text-blue-600 dark:text-blue-400 hover:underline">approvals</Link> and error handling.</>}
					features={agentFeatures}
				/>
			)}

			{/* Tab 2: Claude / Codex / Opencode in sandboxes */}
			{activeTab === 1 && (
				<div>
					<div className="mb-16">
						<h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4">
							Run Claude Code, Codex and Opencode at full power
						</h2>
						<p className="text-lg text-gray-600 dark:text-gray-300">
							Run coding agents like Claude Code, Codex or Opencode inside isolated <Link to="/docs/core_concepts/worker_groups" className="text-blue-600 dark:text-blue-400 hover:underline">sandboxes</Link> where they can use their full capabilities: bash, code writing, file editing and more. Give them scoped <Link to="/docs/core_concepts/roles_and_permissions" className="text-blue-600 dark:text-blue-400 hover:underline">permissions</Link> and <Link to="/docs/core_concepts/resources_and_types" className="text-blue-600 dark:text-blue-400 hover:underline">resource access</Link>, and use them as steps in any flow.
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
						{[
							...
							{ icon: Lock, title: 'nsjail isolation', desc: <span>Each run is sandboxed with nsjail. The agent accesses <Link to="/docs/core_concepts/variables_and_secrets" className="text-blue-600 dark:text-blue-400 hover:underline">secrets</Link> and <Link to="/docs/core_concepts/resources_and_types" className="text-blue-600 dark:text-blue-400 hover:underline">resources</Link> via the Windmill SDK but cannot escape the sandbox.</span> },
...
export default function AiAgentsContent({ title, description }) {
	return (
		<div className="pt-32 max-w-full">
			...
			<UseCaseCarousel
				current="ai-agents"
				subtitle="AI agents are just one use case. The same platform powers internal tools, data pipelines, workflow automations and scheduled tasks."
			/>
