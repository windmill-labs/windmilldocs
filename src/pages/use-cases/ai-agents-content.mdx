			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
				...
				<motion.div {...stagger(0)} className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 p-8">
					...
					<p className="text-base text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
						The <Link to="/docs/core_concepts/ai_agents" className="text-blue-600 dark:text-blue-400 hover:underline">AI agent step</Link> is a ready-to-use node in any flow. The agent reasons, picks <Link to="/docs/core_concepts/ai_agents#script-tools" className="text-blue-600 dark:text-blue-400 hover:underline">tools</Link> (scripts or <Link to="/docs/core_concepts/mcp" className="text-blue-600 dark:text-blue-400 hover:underline">MCP servers</Link>) and executes them in a loop. Use it alongside branching, <Link to="/docs/flows/flow_approval" className="text-blue-600 dark:text-blue-400 hover:underline">approvals</Link> and error handling.
					</p>
					<video
