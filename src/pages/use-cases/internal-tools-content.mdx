...
export const monitorFeatures = [
	{ icon: Eye, title: 'Full execution history', desc: <span>Every run is logged with input, output, duration, errors and resource usage. Search, filter and debug past <Link to="/docs/core_concepts/jobs" className="text-blue-600 dark:text-blue-400 hover:underline">executions</Link> across all scripts and apps.</span>, image: '/img/money-pages/monitoring.webp', docLink: '/docs/core_concepts/jobs' },
