											...
											<div>
												...
												<div className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
													<div className="flex flex-wrap gap-2">
														...
														<span className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs">Compliance checks</span>
														<span className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs">Embedded deployment</span>
														<span className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs">Azure deployment</span>
														<span className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs">Self-hosted infrastructure</span>
														<span className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs">Custom script execution</span>
													</div>
												</div>
											</div>
											<div>
