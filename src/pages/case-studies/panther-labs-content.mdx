...
<div className="space-y-8">
	...
	<div>
		...
		<p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
			Instead of embedding business logic in the workflow platform, Panther built a separate <a href="https://www.windmill.dev/docs/getting_started/scripts_quickstart/python" target="_blank" rel="noopener noreferrer" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">Python</a> library containing all their core logic. Windmill workflows simply orchestrate by calling functions from this library, acting as an execution layer, not a code repository.
		</p>
...
def main(customer_email: str, aws_account_id: str):
	...
	<div>
		...
		<p className="text-gray-700 dark:text-gray-300 leading-relaxed">
			Windmill's native support for importing any Python package from PyPI and private repositories made their architecture possible immediately. No limitations, no workarounds, just full Python language features with proper dependency management and versioning. Everything-as-code with <Link to="https://www.windmill.dev/docs/advanced/git_sync" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">Git sync</Link> gave them proper version control and CI/CD workflows.
		</p>
		<p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
...
<ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4 mb-6">
	...
	<li>Monitoring and alerting: Slack alerts generated through Windmill workflows</li>
