				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
					<CaseStudySidebar
						...
						featuring={{
							...
							role: "Technical Leader, Demo Platform at Zoom",
...
<ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4">
	...
	<li>Polyglot language support — Support <Link to="/docs/getting_started/scripts_quickstart/python" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">Python</Link>, <Link to="/docs/getting_started/scripts_quickstart/typescript" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">TypeScript</Link>, <Link to="/docs/getting_started/scripts_quickstart/bash" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">PowerShell, Bash</Link>, and Ansible for varied technical backgrounds</li>
	<li>Robust <Link to="/docs/core_concepts/scheduling" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">job scheduling</Link> — Handle time-delayed tasks to create realistic content delivery</li>
	<li><Link to="/docs/advanced/self_host" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">Self-host</Link> on Kubernetes — Complete control in their AWS EKS environment</li>
	<li>Everything-as-code — Workflows with proper <Link to="/docs/advanced/git_sync" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">version control</Link></li>
</ul>
<blockquote className="border-l-4 border-blue-500 pl-4 py-2 my-6">
	<p className="text-gray-700 dark:text-gray-300 italic mb-2">
