	...
	return (
		<LayoutProvider>
			<main className="relative min-h-screen w-full overflow-x-hidden">
				<LandingHeader />
				<Head>
					<title>How Twilio scaled workflow automation across technical and non-technical teams | Windmill Case Studies</title>
					<meta name="title" content="How Twilio scaled workflow automation across technical and non-technical teams" />
					<meta name="description" content="Twilio's internal IT team needed a workflow platform that could serve both technical R&D engineers writing complex automation and non-technical GTM teams requiring business-friendly tools." />
