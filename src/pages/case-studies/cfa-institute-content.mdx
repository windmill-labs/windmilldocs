...
def main(endpoint: str, expected_status: int = 200):
	...
	<div>
		...
		<p className="text-gray-700 dark:text-gray-300 leading-relaxed">
			Windmill scripts could be deployed immediately without going through CFA Institute's rigid change management process. With <Link to="https://www.windmill.dev/docs/advanced/git_sync" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">Git sync</Link>, proper version control, and workspace collaboration features, the entire SRE team could work together seamlessly.
		</p>
		<blockquote className="border-l-4 border-blue-500 pl-4 py-2 my-6">
			<p className="text-gray-700 dark:text-gray-300 italic mb-2">
