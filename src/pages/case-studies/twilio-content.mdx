...
<div className="space-y-8">
	...
	<div>
		...
		<p className="text-gray-700 dark:text-gray-300 leading-relaxed">
			As a communications platform handling sensitive customer data, Twilio deployed Windmill <Link to="https://www.windmill.dev/docs/advanced/self_host" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 underline cursor-pointer">self-hosted</Link> in their own cloud infrastructure. This gives them full control over their execution environment while maintaining flexibility to scale as adoption grows across the organization.
		</p>
	</div>
</div>
</section>
