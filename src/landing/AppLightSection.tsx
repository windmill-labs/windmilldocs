		...
		description: (
			<>
				...
				<a
					...
					className="!no-underline"
				>
					<mark className="leading-none bg-orange-100 hover:bg-orange-200 px-2 rounded whitespace-nowrap  text-orange-800 font-semibold">
						GitHub
					</mark>
				</a>
				repository.
	...
	return (
		<LandingSection bgClass="">
			<div className="w-full gap-8 flex flex-col">
				<div className="text-4xl font-medium text-orange-800">Apps</div>
				<div className="text-lg text-gray-600">Code to production in minutes</div>
				<div className="grid grid-cols-2 gap-8">
					<div className="bg-orange-100/40 dark:bg-orange-500/20 p-8 rounded-lg h-[400px] overflow-hidden">
						<div className="font-medium text-xl mb-4">Windmill Smart IDE</div>
					...
					<div className="bg-orange-100/40 dark:bg-orange-500/20 p-8 rounded-lg h-[400px] overflow-hidden col-span-2">
