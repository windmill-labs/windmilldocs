			...
			<div className="flex flex-col w-full gap-4 justify-center" id="app-section">
				...
				<div className="flex gap-4">
					...
					<a
						...
						target="_blank"
						className="inline-flex items-center rounded-md border border-transparent bg-gray-50 px-4 py-2 text-sm font-medium text-stone-700 shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 !no-underline hover:text-sky-600"
					>
						Try building apps
						<ExternalLink className="ml-2 h-5" />
					</a>
