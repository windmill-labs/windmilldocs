...
export const platformLayers = [
	...
	{ label: 'Orchestration', detail: 'Flows, schedules, triggers, AI agents', icon: Cpu, expanded: 'Chain scripts into flows with parallel branches, approval steps and loops. Trigger via cron, webhooks, Kafka, Postgres CDC or custom events.' },
