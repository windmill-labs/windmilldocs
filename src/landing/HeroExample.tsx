		...
		<LandingSection bgClass="bg-white">
			<div className="w-full gap-8 flex flex-col">
				...
				<span className="text-lg text-gray-600 max-w-5xl">
					Make your scripts production grade automatically, and build all of your internal tools with standard Python/Typescript/Go/Bash/Sql. Compose your scripts as advanced workflows using our low-code builder and share an autogenerated UI or build one using low-code. Run it reliably at scale on your infra or ours, with permissioning and monitoring included. Fully open-source and easy to deploy on small and large infra. Any dependency and hardware acceleration with zero-config.
				</span>
