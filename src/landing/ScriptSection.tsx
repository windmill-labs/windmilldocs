			...
			<div className="flex flex-col w-full gap-4 justify-center" id="script-section">
				...
				<div className="flex gap-4">
					...
					<a
						...
						type="button"
						target="_blank"
						className="inline-flex items-center rounded-md border border-transparent bg-gray-50 px-4 py-2 text-zinc-500 font-medium text-white shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 !no-underline hover:text-white"
