...
const USE_CASES = [
	{ id: 'autoui', icon: SlidersHorizontal, label: 'Autogenerated UI', duration: 4500 },
	...
	return (
		<div className="relative w-[560px] h-[280px] mx-auto" style={{ transform: 'scale(0.95)', transformOrigin: 'top center' }}>
			<svg className="absolute inset-0 w-full h-full" style={{ pointerEvents: 'none' }}>
				...
				{branches.map((bx, i) => (
					<path key={`bp-${i}`} id={`dag-br-path-${i}`} d={`M${CX},${150 + NODE_H / 2} C${CX},${187} ${bx},${187} ${bx},${BY - NODE_H / 2}`} fill="none" stroke="none" />
				))}
				...
				>
					...
					<div className="flex flex-col gap-2 min-w-0">
						...
						<div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-gray-200 bg-gray-50 w-fit">
							...
							<span className="text-[10px] text-gray-700 font-mono">get_failed_payment</span>
							{toolDone ? (
