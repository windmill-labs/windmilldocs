---
description: Build custom frontends with React, Svelte or Vue connected to Windmill backend runnables and data tables.
---
...
Full-code apps let you build custom frontends with React, Svelte or Vue that connect to Windmill [backend runnables](./2_backend_runnables/index.mdx) and [data tables](../core_concepts/11_persistent_storage/data_tables.mdx). Unlike the [low-code app editor](../apps/0_app_editor/index.mdx), you write your own components and have full control over the UI.

## How it works

A full-code app is a directory (`.raw_app/`) containing:

- **Frontend code**: React, Svelte or Vue components bundled and served by Windmill
...
|---|---|---|
| **UI** | Custom React/Svelte/Vue components | Drag-and-drop component library |
...
This scaffolds a project with your chosen framework (React, Svelte or Vue), a sample backend runnable, and the necessary configuration. Then start the development server:
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		title="Frontend"
		description="React, Svelte and Vue support, and the wmill.ts API."
