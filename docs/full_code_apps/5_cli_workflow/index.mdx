...
From the app directory, generate `.lock` files for each backend runnable that has dependencies (TypeScript, Python, PHP) using the [`wmill generate-metadata`](../../advanced/3_cli/generate-metadata.md) command:
