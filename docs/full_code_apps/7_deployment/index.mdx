...
Public apps are accessible at their app URL without requiring a Windmill login. The execution policy is auto-generated at deployment time. See [public apps](../../apps/8_public_apps.mdx) for more details.
