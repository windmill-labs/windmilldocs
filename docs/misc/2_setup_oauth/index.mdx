...
Take a look at [this guide](/docs/misc/guides/snowflake_app_with_user_roles#sample-app-setup) to learn more about how to build an App with the Snowflake OAuth integration.
