...
<div class="grid">
	<TaskDurationBarChart
		...
		labels={['Prefect', 'Temporal', 'Windmill N', 'Windmill DW']}
		rawData={[
			[
				[
					1.213, 0.064, 0.061, 0.059, 0.054, 0.053, 0.053, 0.054, 0.055, 0.056, 0.057, 0.064, 0.052,
...
|                    | **Airflow** | **Prefect** | **Temporal** | **Windmill Normal** | **Windmill DW** |
| :----------------: | ----------: | ----------: | -----------: | ------------------: | --------------: |
...
|      **null**      | **Airflow** | **Prefect** | **Temporal** | **Windmill Normal** | **Windmill DW** |
| :----------------: | ----------: | ----------: | -----------: | ------------------: | --------------: |
