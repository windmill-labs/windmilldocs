...
To evaluate orchestrator performance in Go, we tested [Hatchet](/docs/misc/benchmarks/competitors/results/hatchet), [Temporal](/docs/misc/benchmarks/competitors/results/temporal), and [Windmill](/docs/misc/benchmarks/competitors/results/windmill) using a consistent set of benchmark scenarios: 400 lightweight tasks and 100 long-running tasks, both in single-worker and 10-worker configurations.
