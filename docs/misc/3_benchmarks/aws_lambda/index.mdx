...
| **(in seconds)** | **# reps** | **AWS Lambda** | **Windmill<br />Normal** | **Windmill<br />Dedicated Worker** |
|:----------------:|-----------:|---------------:|---------------:|----------------:|
...
| **(in milliseconds)** | **AWS Lambda** | **Windmill<br />Normal** | **Windmill<br />Dedicated Worker** |
|:---------------------:|:--------------:|:--------------:|:---------------:|
| **fibo(10)**          | 73             | 111            | 54              |
...
<div class="grid">
	<TaskDurationBarChart
		title="500 times fibonacci(10) (in seconds)"
...
<div class="grid">
	<TaskDurationBarChart
		title="100 times fibonacci(33) (in seconds)"
		labels={[['AWS Lambda'], ['Windmill', 'Normal'], ['Windmill', 'Dedicated Worker']]}
		rawData={[
			[
				[
