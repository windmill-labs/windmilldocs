...
For partners that wish to offer an end-to-end experience to their customers, we recommend to use the [Cloud Enterprise Edition](/pricing) of Windmill on which users can set up their own customer domain and have a fully-managed Windmill instance that as a partner you will have access to.
