---
description: What are Windmill Certified Partners and how can they help with implementation?
---
...
This requires first being familiar with the editors: [Script editor](../../script_editor/index.mdx), [Flow editor](../../flows/1_flow_editor.mdx), [App editor](../../apps/0_app_editor/index.mdx), and [Full-code apps](../../full_code_apps/index.mdx).
...
This module focuses on Windmill's [App editor](../../apps/0_app_editor/index.mdx) and [full-code apps](../../full_code_apps/index.mdx). It involves being able to build complex apps with [interactions between components](../../apps/2_connecting_components/index.mdx), [background runnables](../../apps/3_app-runnable-panel.mdx#background-runnables), and custom [styling](../../apps/4_app_configuration_settings/4_app_styling.mdx). Partners are also expected to be familiar with all the low-code [components](../../apps/4_app_configuration_settings/1_app_component_library.mdx) and with building full-code apps using React or Svelte with [backend runnables](../../full_code_apps/2_backend_runnables/index.mdx).
