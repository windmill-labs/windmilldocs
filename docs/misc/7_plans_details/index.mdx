...
- Slack integration for [Workspace Error Handling](../../core_concepts/10_error_handling/index.mdx).
- Each seat: $10/month.
- Each seat includes one developer or two operators and 10k executions.
...
Your own hosted dedicated Windmill cluster without restrictions or maintenance.
...
- **How is the use of the number of vCPUs and seats reported to Windmill?**
  ...
  Subscription is self-declared and crossed with the lightweight telemetry that we do. For an air-gapped environment, We kindly request that you export your usage stats by sending us an email containing the data exported by Windmill through the provided export button at the end of the subscription period.
