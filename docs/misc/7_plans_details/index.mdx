...
- As an Enterprise user, you will have access to detailed usage information and invoices through the [Windmill billing portal](#windmill-billing-portal) where you can update plan usage and adjust the number of seats.
...
- To adjust the number of seats, you can update your usage on the subscription page at [Windmill billing portal](#windmill-billing-portal).
...
- As an Enterprise user, you will have access to detailed usage information and invoices through the [Windmill billing portal](#windmill-billing-portal).
...
As an Enterprise user, you will have access to detailed usage information and invoices through the [Windmill Billing Portal](https://portal.windmill.dev/). You can update contact information, billing details and subscription (seats & vCPUs) from the portal.
