...
- Upon subscribing, we will get back to you with a [license key](#using-the-license-key-self-host) to pass in the Instance Settings. The key will self-update every day as long as the subscription is active. A key is valid for 35 days.
