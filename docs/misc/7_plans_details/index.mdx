...
### SMEs & Nonprofits - Self-Hosted

All the same features as [Enterprise Edition](#enterprise-edition---self-hosted), but with regular [support & SLA](../12_support_and_sla/index.mdx).

75% discount from Enterprise Edition.
