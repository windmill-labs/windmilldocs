...
- Upon subscribing, we will get back to you with a [license key](#using-the-license-key-self-host) to pass in the [Instance Settings](../../advanced/18_instance_settings/index.mdx#license-key). The key will self-update every day at 2 a.m CET as long as the subscription is valid (being paid). A key is valid for 35 days.
