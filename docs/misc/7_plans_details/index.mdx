---
description: Windmill pricing plans for cloud and self-hosted deployments. Free, Team and Enterprise tiers with features comparison.
---
...
- `extraEnv`: Environment variables for the native workers:
  - `NUM_WORKERS`: Number of subworker processes (default: 8, counts as 1 Compute Unit)
  - `SLEEP_QUEUE`: Sleep duration between queue polling in milliseconds (default: 200)

You can adjust the `NUM_WORKERS` value based on your needs. Setting it to 0 will disable native workers entirely.
