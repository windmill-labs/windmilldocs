...
You can enhance the bot with persistent context by using [volumes](../../core_concepts/39_persistent_storage/volumes.mdx). Add a volume annotation to the script:
