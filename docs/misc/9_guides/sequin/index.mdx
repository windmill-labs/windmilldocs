...
![Sequin 1](./sequin_1.png)

> _alt: Sequin Console, showing an established connection between Sequin and Airtable_
...
![Sequin 2](./sequin_2.png)

> _Alt: Sequin Console, showing the connection instructions page which lists the credentials for connecting to the Postgres database_
...
Windmill provides integrations with many different apps and services with [resources](../../../core_concepts/3_resources_and_types/index.mdx). Each Resource has a Resource Type (PostgreSQL, MySQL, BigQuery, Snowflake) that defines the schema that the resource of this type needs to implement. 
