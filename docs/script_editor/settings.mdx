---
description: How do I configure script metadata, runtime, and generated UI settings in Windmill?
---
...
You can also configure a **retention period** instead of immediate deletion: toggle the setting and specify a number of seconds. After job completion, logs, arguments and results will be scheduled for deletion after the specified delay. This is available per-script and per-flow-step. [Enterprise](/pricing) only.
