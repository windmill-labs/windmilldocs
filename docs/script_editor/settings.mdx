...
The setting applies to scripts, flows and apps and is global to all users within a workspace but only configurable by [admins](../core_concepts/16_roles_and_permissions/index.mdx#roles-in-windmill).
