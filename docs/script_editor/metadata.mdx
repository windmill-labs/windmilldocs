...
**Path** is the Script's unique identifier that consist of the [script's owner](../core_concepts/16_roles_and_permissions/index.mdx#permissions-and-access-control), and the script's name.
The owner can be either a user, or a group of users ([folder](../core_concepts/8_groups_and_folders/index.md#folders)).
