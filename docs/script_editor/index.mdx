...
In Windmill, Scripts are the basis of all major features (they are the steps of [flows](../getting_started/6_flows_quickstart/index.mdx), [linked to apps components](../apps/3_app-runnable-panel.mdx), or can be [run as standalone](../getting_started/8_trigger_scripts/index.md)).
