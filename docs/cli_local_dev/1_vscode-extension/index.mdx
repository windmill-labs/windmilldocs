---
description: How do I use the Windmill VS Code extension to build and sync scripts and flows locally?
---
...
This validation is also useful for AI coding assistants that monitor IDE diagnostics, as they can automatically detect and fix flow YAML errors.
...
With this toggle, you can choose to use the metadata lockfile (derived from [workspace dependencies](../../core_concepts/55_workspace_dependencies/index.mdx) after [`wmill generate-metadata`](../../advanced/3_cli/generate-metadata.md)) instead of inferring them directly from the script.
