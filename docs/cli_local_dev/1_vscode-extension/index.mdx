...
2. Search for "Windmill" and select the [Windmill extension by Windmill Labs](https://marketplace.visualstudio.com/items?itemName=windmill-labs.windmill).
...
In the settings menu, set the remote url, workspace name and [token](../../core_concepts/4_webhooks/index.md#user-token).
