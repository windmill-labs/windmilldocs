...
[Svix](https://www.svix.com/) offers the possibility to easily add and manage Windmill webhooks
...
After conmfirming that everything is correct, Windmill will redirect to Svix to finish creating the webhook endpoint.
