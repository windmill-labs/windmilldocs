...
To integrate [Google Drive](https://drive.google.com/drive/my-drive?hl=fr) to Windmill, you need to save the following elements as a [resource](../core_concepts/3_resources_and_types/index.mdx).
