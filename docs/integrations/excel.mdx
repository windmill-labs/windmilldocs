...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="Learn about the two main approaches for handling binary data in Windmill: S3/Azure Blob storage and base64 encoded strings."
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="Connect your Windmill workspace to S3 or Azure Blob storage for seamless file handling without credential management."
