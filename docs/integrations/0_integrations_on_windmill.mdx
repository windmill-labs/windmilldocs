...
| [Amazon S3](./aws-s3.mdx)                         | Cloud storage service                                                                                                     |
...
| [Redshift](./redshift.md)                         | Fully managed, scalable data warehouse service designed for large-scale data storage and analytical processing.           |
