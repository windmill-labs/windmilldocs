...
:::info
This network requirement only applies to the Windmill-managed GitHub App. If you use a [self-managed GitHub App](#github-enterprise-server), your Windmill instance communicates directly with your GitHub instance. In that case, if your GitHub organization uses IP allow lists, whitelist your Windmill instance's IP address instead.
:::
...
### Self-managed GitHub App {#github-enterprise-server}
