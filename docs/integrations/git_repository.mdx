...
The first 5 minutes of this video show how to set up a Git repository for a workspace (Git sync - sync mode), the rest of the video shows how to use it to deploy to a Prod workspace using GitHub Actions (Git sync - promotion mode):
