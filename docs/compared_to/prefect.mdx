---
description: How does Windmill compare to Prefect for building workflows, execution runtime, and observability?
---
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="Build custom frontends with React or Svelte connected to Windmill backend runnables."
