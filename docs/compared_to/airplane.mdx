...
Windmill's App Editor works on a drap-and-drop basis, with code where it matters. If you prefer, you can also [import apps in React/Vue/Svelte](../react_vue_svelte_apps/index.mdx) and link them to your scripts and flows.
...
For everyting else, it's comparable: you can [develop locally and source control](../core_concepts/17_collaboration/index.mdx#git-integration), [use VS Code](../cli_local_dev/1_vscode-extension/index.mdx), generate [webhooks](../core_concepts/4_webhooks/index.mdx), etc.
