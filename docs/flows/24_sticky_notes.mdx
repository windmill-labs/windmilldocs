---
description: How do I add sticky notes to annotate and document flows in the Windmill flow editor?
---
...
To document and visually cluster a set of nodes, use [flow groups](./1_flow_editor.mdx#flow-groups) instead.

## Creating sticky notes

Notes can be placed anywhere on the canvas for general comments or documentation.
