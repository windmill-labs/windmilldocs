---
description: How do I test and preview flows directly from the Windmill flow editor?
---
...
On top of its integrated editors ([scripts](../script_editor/index.mdx), [flows](./1_flow_editor.mdx), [low-code apps](../apps/0_app_editor/index.mdx), [full-code apps](../full_code_apps/index.mdx)), Windmill allows users to see and test what they are building directly from the editor, even before deployment.
