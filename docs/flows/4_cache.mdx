---
canonical_url: /docs/core_concepts/caching
description: How do I cache flow step results to avoid redundant computations in Windmill?
---
...
[Step mocking / Pin result](./5_step_mocking.md) allows faster iteration. When a step is mocked, it will immediately return the mocked value without performing any computation.
