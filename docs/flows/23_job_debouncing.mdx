...
- [Time window in seconds](../core_concepts/22_job_debouncing/index.md#time-window-in-seconds)
...
Debouncing can be set for each step of a flow in the `Advanced` menu, on tab "Debouncing".