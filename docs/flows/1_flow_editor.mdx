...
The Flow Builder has the following major components we will detail in a [dedicated page](3_editor_components.mdx):

- [Toolbar](./3_editor_components.mdx#toolbar): the toolbar allows you to export the flow, configure the flow settings, and test the flow.
- [Settings](./3_editor_components.mdx#settings): configure the flow settings.
- [Static Inputs](./3_editor_components.mdx#static-inputs): view all flow static inputs.
- [Flow Inputs](./3_editor_components.mdx#flow-inputs): view all flow inputs.
- [Action](./3_editor_components.mdx#flow-actions): steps are the building blocks of a flow. They are the actions that will be executed when the flow is run.
- [Action editor](./3_editor_components.mdx#action-editor): configure the action.
