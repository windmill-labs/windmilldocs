...
Inline scripts support [Python version selection](../../getting_started/0_scripts_quickstart/2_python_quickstart/index.mdx#select-python-version) using annotations or version specifiers:
