...
Flows can be assigned custom [worker groups](../core_concepts/9_worker_groups/index.md) for efficient execution on different machines with varying specifications.
