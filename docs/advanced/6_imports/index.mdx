...
For each language, there is a way to pin the version directly within script (see above). This is the recommended way of managing dependencies and the authoritative way of handling dependencies via the UI.
