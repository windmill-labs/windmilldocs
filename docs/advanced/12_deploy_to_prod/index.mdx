...
If you're looking for opinionated, step-by-step guidance, see [Canonical deployment setups](../14_canonical_deployment_setups/index.mdx) for two recommended deployment models: a UI-only workflow and a Git-based workflow.
