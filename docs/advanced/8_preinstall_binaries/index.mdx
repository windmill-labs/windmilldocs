...
<iframe
    ...
    src="https://www.youtube.com/embed/2o28HMF1Cnk?vq=hd1080"
...
```bash
curl ghcr.io/windmill-labs/windmill-ee:main
apt update
apt install npm -y
...
apt-get update -y
apt install nodejs libnss3-dev  libatk1.0-0 libatk-bridge2.0-0 libcups2-dev  libdrm-dev libxkbcommon-dev libxcomposite-dev libxdamage-dev libxrandr-dev\
  libgbm-dev libpango-1.0 libcairo-dev libasound-dev -y
