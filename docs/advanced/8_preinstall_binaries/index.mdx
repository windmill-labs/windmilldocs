...
To have packages be available for import, place them in `/tmp/windmill/cache/python_x_y_z/global-site-packages` where x_y_z is the python version intended. For python 3.11, the path would be `/tmp/windmill/cache/python_3_11/global-site-packages`, for python 3.11.11 - `/tmp/windmill/cache/python_3_11_11/global-site-package`
