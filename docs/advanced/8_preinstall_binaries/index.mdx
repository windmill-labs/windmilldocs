...
Workers in Windmill.dev can preinstall binaries. This allows them to execute these binaries in subprocesses or directly within bash. While some common binaries like npm, aws-cli, kubectl, and helm are already present in the standard images, you can easily add more by extending the base image of Windmill.
