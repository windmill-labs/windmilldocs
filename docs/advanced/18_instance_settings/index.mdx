...
Anonymous usage data is collected to help improve Windmill. It's a simple HTTP to https://stats.windmill.dev. Stats are sent once a day. Stats only contain size of workers, their uptime and number of seats used.
