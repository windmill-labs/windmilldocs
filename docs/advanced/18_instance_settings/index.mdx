...
Alternatively, you can set the `INSTANCE_EVENTS_WEBHOOK` environment variable. The environment variable takes precedence over the DB setting. The DB value is cached for 60 seconds.
