...
You can annotate the version of Python you would like to use for a script using the annotations like py310, py311, py312, or py313, or use version specifiers like `py: >=3.12`.
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="You can annotate the version of Python you would like to use for a script using annotations or version specifiers like py: >=3.12"
