---
description: How do I synchronize folders and git repositories to a Windmill instance using the CLI?
---
...
For a human-readable walkthrough of every `wmill.yaml` option — with defaults, effects, and deprecated keys — see the [`wmill.yaml` reference](./wmill-yaml-reference.mdx).
