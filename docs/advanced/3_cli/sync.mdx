...
skipVariables: true
skipResources: true
# skipResourceTypes: [] # Specify resource types to skip, e.g., ['postgresql_db', 's3_bucket']
skipSecrets: true
...
export interface SyncOptions {
	...
	/** Specify which resource types should be skipped. Takes an array of resource type names. */
