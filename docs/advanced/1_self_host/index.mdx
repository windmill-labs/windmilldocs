...
```sql
GRANT ROLE windmill_admin TO <user used in database_url>;
GRANT ROLE windmill_user TO <user used in database_url>;
```

If you cannot use BYPASSRLS (for instance on Azure PostgreSQL), see this [workaround](https://github.com/windmill-labs/windmill/issues/2345#issuecomment-1739777068)
:::
