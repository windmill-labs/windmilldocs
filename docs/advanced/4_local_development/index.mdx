...
For each language, there is a way to [pin the version directly within script](../6_imports/index.mdx#pinning-dependencies-and-requirements). This is the recommended way of managing dependencies.
