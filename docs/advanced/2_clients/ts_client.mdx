...
For more details and documentation on the client, you can visit [jsr.io/@windmill/windmill](https://jsr.io/@windmill/windmill), although jsr.io is not supported for actual package imports yet.