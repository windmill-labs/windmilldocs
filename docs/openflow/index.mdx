...
[Upon new user signup, check for existence in postgres, hash password, add record to postgres and airtable, send an email to new user](https://hub.windmill.dev/flows/23/)),
