...
![Schedule Error Handler](../1_scheduling/14_schedule_error_handler.png)
...
![Workspace Error Handler](./workspace_error_handler.png)
...
From the superadmin workspace's settings, pick the "Error Handler" tab and pick a script.
...
This Superadmin Error handler is defined by an environment variable: `GLOBAL_ERROR_HANDLER_PATH_IN_ADMINS_WORKSPACE`.

Here is a template for your Superadmin workspace error handler:
