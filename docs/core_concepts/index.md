...
<div class="grid grid-cols-2 gap-2 mb-4">
  ...
  <a href="/docs/core_concepts/draft_and_deploy" class="rounded-md p-6 border border-gray-200 hover:border-blue-500 transition-all cursor-pointer flex flex-col gap-2 !no-underline" target="_blank">
  ...
  <a href="/docs/core_concepts/webhooks" class="rounded-md p-6 border border-gray-200 hover:border-blue-500 transition-all cursor-pointer flex flex-col gap-2 !no-underline" target="_blank">
