...
Within Windmill scripts, the ephemeral token for the current job is available as the `WM_TOKEN` environment variable. See [add resources and variables to code](../../code_editor/add_variables_resources.mdx) for details.
