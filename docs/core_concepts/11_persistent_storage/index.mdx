...
2. [Object storage for large data](#large-data-files-s3-r2-minio) such as S3.
...
Windmill comes with a native integration with S3, making it the recommended storage for large objects like files and binary data.
...
### Connects your Windmill workspace to your S3 bucket

Once you've created an S3 resource in Windmill, got to the workspace settings > S3 Storage. Select the resource and click Save.

From there, Windmill makes it easy to interact with S3 objects directly from scripts.
