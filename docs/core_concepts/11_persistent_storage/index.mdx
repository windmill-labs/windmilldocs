...
2. [Object storage for large data](#object-storage-for-large-data-s3-r2-minio-azure-blob) such as S3.
...
4. [NoSQL and document database](#nosql-and-document-databases-mongodb-key-value-stores) such as MongoDB and Key-Value stores.
