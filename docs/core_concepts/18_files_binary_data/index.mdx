...
The recommended way to store binary data is to upload it to S3 leveraging [Windmill's native S3 integration](../11_persistent_storage/large_data_files.mdx).
...
language as defined in the [schema](../13_json_schema_and_parsing/index.md).
