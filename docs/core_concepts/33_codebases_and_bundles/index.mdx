...
- Using [relative imports](../../advanced/6_imports/index.md#relative-imports) to import scripts from the same workspace
- Deploy a private/public packages and import them in your scripts [using the package manager](../../advanced/6_imports/index.md#private-npm-registry--private-npm-packages)
