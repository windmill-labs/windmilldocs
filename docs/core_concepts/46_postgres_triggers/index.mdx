...
For more information on **Postgres replication slots**, refer to the [Postgres documentation on replication slots](https://www.postgres.org/docs/current/logical-replication-slot.html).
