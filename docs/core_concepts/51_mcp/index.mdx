...
- **[Resources](../3_resources_and_types/index.mdx)** - Create, read, update, and delete [resource configurations](../3_resources_and_types/index.mdx) for third-party system connections like databases and APIs
