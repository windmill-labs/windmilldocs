---
description: What are workspace settings and how do I configure users, Git sync, storage, and other workspace options?
---
...
- [Default App](../../apps/1_default_app/index.md) - Configure the default application settings and [rate limiting for public apps](../../apps/8_public_apps.mdx#rate-limiting)
