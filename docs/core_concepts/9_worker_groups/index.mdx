...
to them. They are at the basis of [Windmill's architecture](../../misc/10_architecture/index.md).
...
Managing workers is useful for mastering Windmill in depth by assigning different nodes to jobs. By default, every worker is the same and interchangeable.
...
<img src={require("./wg_config_infographics.png").default} alt="Worker group config infographics" title="Worker group config infographics" width="75%" />

<br/>

Tags and Queues infographics:

<img src={require("./tags_and_queues.png").default} alt="Tags and Queues infographics" title="Tags and Queues infographics" width="75%" />
