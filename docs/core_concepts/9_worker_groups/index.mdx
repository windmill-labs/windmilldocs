...
> [Go to section](#set-tags-to-assign-specific-queues).
...
> [Go to section](#create-worker-group-config).
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
  <img src={require("../../advanced/8_preinstall_binaries/init_scripts.png").default} alt="Init Scripts Infographics" title="Init Scripts Infographics" width="70%" />
</div>
