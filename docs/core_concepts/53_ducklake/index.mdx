...
The catalog database corresponds to the resource you specified as the catalog database in your Ducklake configuration. You can visualize its content from the [resources page](/docs/core_concepts/3_resources_and_types/index.mdx) in your workspace. Note that it is currently not possible to visualize the content of a catalog of type Instance.
