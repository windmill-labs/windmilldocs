...
You just need to [configure SMTP](../../advanced/1_self_host/index.mdx#set-up-smtp-from-the-ui) and setup a critical alert channel (aka email address) in the instance settings or connect your instance to Slack and fill in a channel name.
