...
For now, dedicated workers are only available with [Bun scripts](../../getting_started/0_scripts_quickstart/1_typescript_quickstart/index.mdx) that have been pre-deployed.
