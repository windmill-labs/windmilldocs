...
Windmill offers a draft system for scripts, flows, and apps (both [low-code](../../apps/0_app_editor/index.mdx) and [full-code](../../full_code_apps/index.mdx)), allowing multiple iterations and collaboration before deploying. Drafts are available to anyone with write access to the underlying item. It provides a simple way to iterate on items with multiple collaborators.
