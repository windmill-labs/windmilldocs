...
### S3 object access in public apps

By default, S3 objects are not accessible in public apps when users aren't logged in. 
...
Signed S3 objects can be used in the [Image](../../apps/4_app_configuration_settings/image.mdx) or [Rich result](../../apps/4_app_configuration_settings/rich_result.mdx) app components.
