...
Windmill provides an endpoint that exposes workspace storages via the S3 protocol. It is used by DuckDB scripts when accessing S3, but you can use it yourself with any S3 Client:
