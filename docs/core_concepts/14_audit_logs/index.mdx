...
Audit Logs can be filtered by Date, Username, Action (Create, Update, Delete, Execute), and specific Operation. The [Runs menu]{/docs/core_concepts/monitor_past_and_future_runs} is another feature that allows you to visualise all past and future runs.
