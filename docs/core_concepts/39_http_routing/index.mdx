...
This lets you automatically document your API surface, including routing, authentication, and metadata — ready for sharing, client SDK generation, or integration with API gateways and documentation tools.
