...
1. Navigate to the **Custom HTTP routes** page.
2. Click the **New route** button.
3. Fill in the route configuration fields:
   - **Path**: The route path (e.g., `/webhooks/github/:event`)
   - **HTTP method**: One of GET, POST, PUT, PATCH, DELETE
   - **Runnable**: The script or flow to trigger (or serve static content)
   - Optional fields:
     - **Authentication method**
     - **Async vs sync behavior**
     - **Body handling options**
     - **Static asset or website settings**
     - Etc.
