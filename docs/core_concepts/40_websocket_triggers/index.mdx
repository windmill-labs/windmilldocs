...
Windmill extracts the `s` field from every incoming Discord event and substitutes it into the heartbeat message automatically. See the [Discord bot guide](../../misc/9_guides/discord_bot/index.mdx) for a complete walkthrough.
