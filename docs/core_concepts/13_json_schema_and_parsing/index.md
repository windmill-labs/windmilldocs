...
The JSON Schema of a script's arguments can be modified in the "Customize Inputs" section of the `Flow Input` menu. The schema is visible from the `Export / OpenFlow` section, in particular the "Input Schema" tab.
