...
**Note**: Only HTTP streamable MCP servers are supported. This enables real-time tool execution and streaming responses between the AI agent and the MCP server.
