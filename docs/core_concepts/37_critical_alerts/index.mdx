---
description: How do I configure critical alerts for job crashes, license issues, and worker health in Windmill?
---
...
- API token is about to expire (within 7 days) or has expired (requires ["Alert on token expiry"](../../advanced/18_instance_settings/index.mdx#alert-on-token-expiry) to be enabled in instance settings).
