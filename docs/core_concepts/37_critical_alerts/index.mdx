...
You just need to [configure SMTP](../../advanced/18_instance_settings/index.mdx#smtp) and setup a critical alert channel (aka email address) in the [instance settings](../../advanced/18_instance_settings/index.mdx#smtp) or connect your instance to Slack and fill in a channel name.
