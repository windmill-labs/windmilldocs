...
The flow builder includes an integrated AI chat panel that lets you create and modify flows using natural language. 
Just describe what you want to achieve, and the AI will build the flow for you, step by step.

It can add scripts, loops, and branches — searching your workspace and the Windmill Hub for relevant scripts or generating new ones when needed or on request.
