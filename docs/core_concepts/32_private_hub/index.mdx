...
If you're using the [Helm chart](https://github.com/windmill-labs/windmill-helm-charts/blob/main/charts/windmill/values.yaml), there is a built-in `cookieDomain` value for this.
