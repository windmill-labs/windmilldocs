...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="You can set and get progress of execution of specific script. This will be reflected by progress bar in UI."
		href="/docs/core_concepts/explicit_progress"
	/>
	<DocCard
