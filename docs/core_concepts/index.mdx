...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="Powered by the super fast search engine Tantivy, search through jobs based on their logs, arguments, results..."
		href="/docs/core_concepts/full_text_search"
	/>
</div>
