...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="Manage Windmill instance configuration declaratively with YAML files or Kubernetes CRDs."
	...
	<DocCard
		...
		description="Build apps with React, Svelte or Vue connected to Windmill backend runnables."
...
Build custom frontends with React, Svelte or Vue, connected to Windmill backend runnables and [data tables](../core_concepts/11_persistent_storage/data_tables.mdx). See the [full-code app section](../full_code_apps/index.mdx).
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="Learn about the file structure, raw_app.yaml and auto-generated files."
