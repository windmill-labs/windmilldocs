...
| `form` | `object` / `dict` | `undefined` / `None` | JSON Schema describing form fields shown on the approval page (EE only) |
...
| `form` | `object` | `undefined` | JSON Schema for an approval form (EE only) |
...
| `form` | `dict \| None` | `None` | JSON Schema dict for an approval form (EE only) |
