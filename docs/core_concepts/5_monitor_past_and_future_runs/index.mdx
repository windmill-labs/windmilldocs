...
<div class="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		title="Audit Logs"
		description="Audit logs are another feature, available in the Enterprise & Team Editions only. They capture and record every operation and action with side-effects."
