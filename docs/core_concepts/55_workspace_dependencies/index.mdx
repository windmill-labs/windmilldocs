---
description: How do I manage shared dependencies centrally at the workspace level in Windmill?
---
...
This feature is available on [Enterprise Edition](/pricing) only.
...
wmill generate-metadata my_script.py
```
...
<div className="grid grid-cols-2 gap-6 mb-4">
  ...
  />
  <DocCard
    title="Shared runners (dedicated workers)"
    description="Run multiple dedicated worker scripts sharing the same workspace dependency in a single subprocess."
    href="/docs/core_concepts/dedicated_workers#shared-runners"
  />
</div>
