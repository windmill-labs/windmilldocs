...
We still recommend using [user-defined variables](#user-defined-variables) but in some cases (e.g. your imports depend on env variables), this might be a good escape hatch.

![Create Custom Contextual Variable](./create_custom_contextual_variable.png)
