...
<TabItem value="typescript" label="TypeScript (Deno)" attributes={{className: "text-xs p-4 !mt-0 !ml-0"}}>
...
<TabItem value="py" label="Python" attributes={{className: "text-xs p-4 !mt-0"}}>
