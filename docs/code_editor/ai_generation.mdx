...
On the workspace settings, go to the "OpenAI Credentials" tab and fill with a secret key from [OpenAI's API menu](https://help.openai.com/en/articles/4936850-where-do-i-find-my-secret-api-key).

![Secret Key](../assets/code_editor/openai_credentials.png "OpenAI Secret Key")
