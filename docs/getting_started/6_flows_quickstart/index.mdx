...
Last tab of the settings menu is the [Shared Directory](../../core_concepts/11_persistent_storage/index.md#shared-directory).
...
- [Dynamically linked to others](../../flows/16_architecture.md): with [JSON objects](../../core_concepts/13_json_schema_and_parsing/index.md) as result that allow to refer to the output of any step.
