---
description: How do I write and run scripts in Windmill? Quickstart guides for TypeScript, Python, Go, PHP, Bash, SQL, Rust, C#, Java, Ruby, R and Docker.
---
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		title="R"
		description="Write your first Windmill script in R."
		href="/docs/getting_started/scripts_quickstart/r"
		Icon={SiR}
	/>
</div>
...
Not sure which language to choose? Compare features like SDK support, LSP integration, dependency management, and platform capabilities across all supported languages.

<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		title="Language support comparison"
		description="Compare features available across TypeScript, Python, Go, Bash, SQL, PHP, Rust, C#, Java, Ruby, and Ansible."
		href="/docs/script_editor/language_support"
	/>
</div>
