---
title: 'Nu quickstart'
slug: '/getting_started/scripts_quickstart/nu'
---
...
In this quick start guide, we will write our first script in [Nu](https://learn.microsoft.com/en-us/dotnet/csharp/tour-of-csharp/overview).

![Editor for Nu](./editor_csharp.png "Script in Nu")
