...
To be able to connect to a Postgres instance ([Supabase](../../../integrations/supabase.md), [Neon.tech](../../../integrations/neon.md)), we'll need to define a Resource with the `PostgreSQL` Resource Type first.
...
Fill out the form with the information of your PostgreSQL/MySQL instance and "Test connection" if needed.
...
![Select Resource Type](./select_mysql.png)
