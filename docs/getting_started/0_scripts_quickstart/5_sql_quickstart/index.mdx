...
![Postgresql statement](./postgresql_statement.png)
...
This method will imply going through a [Typescript script](../1_typescript_quickstart/index.mdx): [Execute Query and return results](https://hub.windmill.dev/scripts/postgresql/1294/execute-query-and-return-results-postgresql).
