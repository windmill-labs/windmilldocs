...
# Quickstart PostgreSQL / MySQL / BigQuery / Snowflake
...
of [Resources][docs-resources]. Resources are rich objects in JSON that allow to store configuration and credentials.

Each Resource has a _Resource Type_ ([PostgreSQL](https://hub.windmill.dev/resource_types/6/postgresql), [MySQL](https://hub.windmill.dev/resource_types/111/mysql), [BigQuery](https://hub.windmill.dev/resource_types/108/bigquery), [Snowflake](https://hub.windmill.dev/resource_types/107/snowflake))
