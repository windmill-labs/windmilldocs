...
Alternatively, you can set a global version by configuring the INSTANCE_PYTHON_VERSION [environment variable](../../../core_concepts/2_variables_and_secrets/index.mdx) to one of the mentioned versions or unset it to use "Latest Stable".
