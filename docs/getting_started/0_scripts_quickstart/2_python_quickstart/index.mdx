...
You can also use version specifiers to allow a range of compatible Python versions:
...
- `py: >=3.11` - Python 3.11 or higher
- `py: >=3.12,<3.14` - Python 3.12 or 3.13 (but not 3.14+)
- `py: ==3.12` - Exactly Python 3.12
