...
In this quick start guide, we will write our first script in TypeScript. Windmill uses [Deno](https://deno.land/) and [Bun](https://bun.sh/) as the TypeScript runtime and is compatible with [Node.js](https://nodejs.org/) using Bun.
...
![New script](./create_script_deno.png.webp)
...
![Editor for Deno](./editor_deno.png.webp)
...
- [Deno](#deno)
- [Bun](#bun) (compatible almost 1:1 with [Node.js](#nodejs))
...
Windmill pre-bundles your script at deployment time using [Bun bundler](https://bun.sh/docs/bundler). This improve memory usage and speed up the execution time of your script. If you would like to disable this feature, you can add the following comment at the top of your script:
...
The only thing you need to do is to select [TypeScript (Bun)](#bun) as the runtime and as the first line, use:
