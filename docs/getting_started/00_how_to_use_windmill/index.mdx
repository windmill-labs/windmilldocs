...
- Check how to [trigger scripts](../8_trigger_scripts/index.mdx) and [trigger flows](../9_trigger_flows/index.mdx) to get an idea of what you could do with Windmill.
