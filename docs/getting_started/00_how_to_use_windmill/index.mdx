...
- Have a look at our quickstarts (on [Scripts](../../getting_started/0_scripts_quickstart/1_typescript_quickstart/index.mdx), [Flows](../6_flows_quickstart/index.md) or [Apps](../7_apps_quickstart/index.mdx)) that give an introduction on how to build your first ones.
