...
> Example of an app buit with Windmill App Editor.
...
The **[Ouputs](../../apps/2_outputs.mdx)** of each component can be found on the left side menu. Each of them is associated with a component (see the component id).
...
You can do a refresh all for the whole app with the refesh button on top of the canvas, or schedule automatic refesh.

![Refresh app](./refresh_app.png.webp)

Most convenient solution to test your app might just be to [preview](../../apps/0_toolbar.md#preview-mode) it:
