...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="Prefer React, Svelte or Vue? Build full-code apps connected to Windmill backend runnables and data tables."
