...
- [API](#trigger-from-api) & [Webhooks](#webhooks), including from [Slack](#webhooks-trigger-scripts-from-slack)
- [Emails](#emails)
- [Custom HTTP routes](#custom-http-routes)
- [Websocket triggers](#websocket-triggers)
- [Scheduled polls (Scheduling + Trigger scripts)](#scheduled-polls-scheduling--trigger-scripts)
