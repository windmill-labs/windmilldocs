...
- **Path** is the Script's unique identifier that consist of the
  ...
  script under your path, and call it `hello_world_ts`.
...
We picked `typescript` for this example, so Windmill provided some TypeScript
...
![Advanced settings for TypeScript](../assets/getting_started/quickstart/advanced_ts.png)
...
![Run hello world in TypeScript](../assets/getting_started/quickstart/run_ts.png)
