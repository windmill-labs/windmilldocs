...
Not only that, but we also took care of doing an exhaustive hierarchy of [classes](#class-identifiers) that correspond to the strucuture ou our components, enabling to customize any aspect of them.
