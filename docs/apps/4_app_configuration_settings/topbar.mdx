---
description: What is the Top bar component in Windmill? Display a header bar with the app summary and a recompute all button.
---
...
In that case, the Text component has by default template value `${ctx.summary}` which will display the [context](../2_outputs.mdx#app-context) [Summary](../0_toolbar.mdx#app-summary) of the app.
