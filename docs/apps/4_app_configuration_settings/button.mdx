---
description: What is the Button component in Windmill? Trigger runnables on click with static or connected parameters.
---
...
The button component has the following event handler:
