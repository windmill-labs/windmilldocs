---
description: What is the AgGrid table in Windmill? Display and edit tabular data with sorting, filtering and pagination.
---
...
Its independent from Windmill's [Enterprise Edition](/pricing).
