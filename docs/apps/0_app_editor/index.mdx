...
<div class="grid grid-cols-2 gap-2 mb-4">
	...
	<DocCard
		...
		description="Learn about the lifecycle of a component."
		href="/docs/apps/outputs"
	/>
	<DocCard
		title="Background runnable Lifecycle"
		description="These outputs correspond to the outputs of the individual components."
		href="/docs/apps/outputs"
	/>
</div>
