...
<div class="grid grid-cols-2 gap-2 mb-4">
  <a href="/docs/getting_started/apps_quickstart" class="rounded-md p-6 border border-gray-200 hover:border-orange-500 transition-all cursor-pointer flex flex-col gap-2 !no-underline" >
   <div class="text-lg font-semibold text-gray-900">Apps Quickstart</div>
    <div class="text-sm text-gray-500">Learn how to build your first app in a matter of minutes.</div>
  </a>
  <a href="/docs/react_vue_svelte_apps" class="rounded-md p-6 border border-gray-200 hover:border-blue-500 transition-all cursor-pointer flex flex-col gap-2 !no-underline" >
   <div class="text-lg font-semibold text-gray-900">React/Vue/Svelte Apps</div>
    <div class="text-sm text-gray-500">Users can import their own React/Vue/Svelte Apps in addition to using Windmill's built-in App editor.</div>
  </a>
</div>
