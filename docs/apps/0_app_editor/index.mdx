---
description: How do I build apps in Windmill? Use the low-code app editor with drag-and-drop components, custom CSS and React components.
---
...
The low-code app editor is a drag-and-drop builder to create custom User Interfaces with a mix of visual components and code. For building apps with React, Svelte or Vue, see [Full-code apps](/docs/full_code_apps).
