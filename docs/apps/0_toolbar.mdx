...
You can [save](../core_concepts/0_draft_and_deploy/index.md) the app. The first time you save the app, you'll be asked to select the owner of the app. You can choose either a user or a [folder](../core_concepts/8_groups_and_folders/index.md#folders).
...
![Deployement history](../assets/apps/1_app_toolbar/deployement-history.png)

## Deploy

You can [deploy](../core_concepts/0_draft_and_deploy/index.md#deployed-version) the app as a standalone app via a URL. There are two ways to publish an app:
