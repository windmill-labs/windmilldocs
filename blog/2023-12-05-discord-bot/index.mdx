...
For developers working with Discord bots, Windmill's new [Early return](/docs/flows/early_return) feature is a practical solution to a common challenge{/* truncate */}: ensuring your bot responds quickly to commands, especially when dealing with complex workflows.

![Windmill Discord](./discord.png 'Windmill Discord')

### The Challenge with Discord Bots

[Discord requires bots to respond to commands within 3 seconds](https://discordjs.guide/slash-commands/response-methods), which can be limiting when your bot needs to execute multiple steps.
