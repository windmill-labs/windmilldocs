...
<!-- TODO: create hero illustration showing a TypeScript file with workflow/task annotations on the left, and the resulting DAG visualization on the right -->
...
<!-- TODO: video showing a workflow-as-code script running with the DAG visualization updating in real-time. Path suggestion: /videos/workflow_as_code_demo.webm -->
