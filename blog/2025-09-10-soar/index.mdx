...
Apps and assets inherit access from [groups and folders](/docs/core_concepts/groups_and_folders), and you can keep changes safe with separate [staging and production](/docs/advanced/git_sync#git-promotion-workflow-cross-instance-deployment-using-a-git-workflow) environments.
