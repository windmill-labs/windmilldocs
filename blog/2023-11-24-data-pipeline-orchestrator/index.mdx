...
_Run your ETLs on-prem up to 5x faster using Windmill compared to Spark while simplifying your infra_

Last day of our launch week today (we know it's sad). Before saying goodbye, we want to tell you about features that will help you in your ETL, with restartable flows and S3 integration for data pipelines (this article).
...
- Those queries were ran sequentially as scripts in for-loop flow in Windmill, and this for each of the benchmark set of data (1Gb, 5Gb, 10Gb, etc.). The memory of the Windmill server was recorded.
- Each script was:
