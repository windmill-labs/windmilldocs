...
**Day 1 of [Windmill launch week](/launch-week-march-2026).** We are shipping two new storage primitives: **Data Tables** for relational data with managed SQL, and **Ducklake** for massive datasets backed by S3.
...
Tomorrow is Day 2: **Full code apps**. Build complete applications with React and Svelte frontends connected to Windmill backend logic. [Follow along](/launch-week-march-2026).
