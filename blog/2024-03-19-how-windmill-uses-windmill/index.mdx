...
The good thing of being a devtool company is that your developers use their own tools on a daily basis {/* truncate */} (it would be more complicated to get them motivated with accounting software).
