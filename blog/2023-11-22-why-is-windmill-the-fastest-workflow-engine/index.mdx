...
_Big claim today: We've benchmarked Windmill to be the fastest self-hostable generic workflow engine among Airflow, Prefect and even Temporal. For Airflow, there is quite a margin, up to 10x faster!_
...
- pass data in S3 using the [workspace object storage](/core_concepts/object_storage_in_windmill#workspace-object-storage) (updates specific to that part to be presented on day 5)
