...
# Launch Week Day 1 - VS Code extension
...
![VS Code extension](./vscode_extension.png.webp 'VS Code extension')

Introducing the new Windmill [VS Code extension](https://marketplace.visualstudio.com/items?itemName=windmill-labs.windmill) to build scripts and flows in the comfort of your VS Code or Cursor editor, while leveraging Windmill UIs for test & flows edition.
...
![Windmill own IDE](./script_ide.png.webp 'Windmill Own IDE')
...
![Local workspace](./local_workspace.png.webp)
...
With [wmill sync pull](/docs/advanced/cli/sync#pulling) and [wmill sync push](/docs/advanced/cli/sync#pushing) you can synchronize your remote workspace to a local directory which you would version with GitHub / GitLab.
...
- When editing a flow YAML, you it contains the flow builder and the flow [test UI](/docs/flows/test_flows).
