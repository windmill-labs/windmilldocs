...
title: 'Git sync & workspace forks: deploy with confidence'
---

import DocCard from '@site/src/components/DocCard';

# Git sync & workspace forks: deploy with confidence
...
<!-- TODO: create hero illustration showing a Git branching diagram with a Windmill workspace forking from main, making changes, and merging back -->
