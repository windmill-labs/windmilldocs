...
## Day 2 - Worker Groups Configuration
...
To that end, we introduce the concept of "worker groups", for example:
- [Give tags to workers](/docs/core_concepts/worker_groups) to assign specific jobs to them.
