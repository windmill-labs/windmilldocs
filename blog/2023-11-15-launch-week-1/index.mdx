...
[![VS Code Extension](../2023-11-20-vscode/vscode_extension.png 'VS Code Extension')](/blog/launch-week-1/vscode-extension)
...
[![Worker Groups Management UI & Hot Reloading](../2023-11-21-a-workers-group/worker_groups_configuration_thumbnail.png 'Worker Groups')](/blog/launch-week-dedicated-workers)

Today's first annoucement of the day is the power of Worker Groups Configurations.
...
You can assign worker groups to flows and flow steps to be executed on specific queues. The name of those queues are called tags. Worker groups listen to those tags.
...
[![Dedicated Workers for scripts](../2023-11-21-a-workers-group/worker_groups_configuration_thumbnail.png 'Dedicated Workers for Scripts')](/blog/launch-week-dedicated-workers)

Dedicated Workers for scripts enable to reach up to 1000rps per worker for a given script. It makes windmill faster than AWS Lambda and compatible with event-streaming use cases.
...
<div class="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="https://www.windmill.dev/blog/launch-week-dedicated-workers"
		href="/blog/launch-week-1/worker-groups"
	/>
</div>
