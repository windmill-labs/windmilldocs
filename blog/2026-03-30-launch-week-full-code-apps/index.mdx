...
<TabItem value="get-marketing-activation" label="Marketing script" attributes={{className: "text-sm p-4 !mt-0 !ml-0"}}>
...
<TabItem value="get-sales-metrics" label="Sales script" attributes={{className: "text-sm p-4 !mt-0 !ml-0"}}>
...
/>
<p className="text-xs text-gray-500 mb-6 text-center">Local development with <code>wmill app dev</code>.</p>
