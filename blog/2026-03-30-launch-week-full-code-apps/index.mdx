...
<video
  ...
  loop
  muted
  src={require('./windmill-ui-app-demo.mp4').default}
/>
<p className="text-xs text-gray-500 mb-6 text-center">Building a full-code app from the Windmill UI with AI assistance.</p>
