...
## Example: AI chatbot with Windmill scripts as tools
...
<Tabs>
<TabItem value="frontend" label="Full-code frontend" attributes={{className: "text-lg font-semibold p-4 !mt-0 !ml-0"}}>
...
<TabItem value="backend" label="Windmill backend runnables" attributes={{className: "text-lg font-semibold p-4 !mt-0 !ml-0"}}>
...
{/* TODO: screenshot of the AI agent flow in the Windmill flow editor, showing the steps: receive message, call AI model with tools, return response. Path suggestion: ./ai_agent_flow.png */}

<div style={{width: '100%', height: '400px', backgroundColor: '#1e1e2e', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#888', fontSize: '14px'}}>
  Screenshot placeholder: AI agent flow in the Windmill flow editor
</div>

</TabItem>
<TabItem value="get-marketing-activation" label="Get marketing activations" attributes={{className: "text-sm p-4 !mt-0 !ml-0"}}>

A tool the AI agent can call to look up marketing activation data from connected sources.

{/* TODO: screenshot of the get_marketing_activation script in the Windmill script editor. Path suggestion: ./get_marketing_activation.png */}

<div style={{width: '100%', height: '400px', backgroundColor: '#1e1e2e', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#888', fontSize: '14px'}}>
  Screenshot placeholder: get_marketing_activation script in the Windmill script editor
</div>

</TabItem>
<TabItem value="get-sales-metrics" label="Get sales metrics" attributes={{className: "text-sm p-4 !mt-0 !ml-0"}}>

A tool the AI agent can call to query sales metrics from the database.

{/* TODO: screenshot of the get_sales_metrics script in the Windmill script editor. Path suggestion: ./get_sales_metrics.png */}

<div style={{width: '100%', height: '400px', backgroundColor: '#1e1e2e', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#888', fontSize: '14px'}}>
  Screenshot placeholder: get_sales_metrics script in the Windmill script editor
</div>
