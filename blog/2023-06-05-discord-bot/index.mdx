...
<div class="grid grid-cols-2 gap-6 mb-4">
	<DocCard title="For loops" description="For loops documentation" link="/docs/flows/flow_loops" />
	<DocCard
		title="Scheduling"
		description="Scheduling documentation"
		link="/docs/core_concepts/scheduling"
	/>
</div>
