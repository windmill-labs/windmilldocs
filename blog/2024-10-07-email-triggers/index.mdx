...
We use `Framed` with `LinesCodec` from the <a href="https://crates.io/crates/tokio-util" rel="nofollow">tokio-util</a> crate to split the stream by lines.
...
The `handle_starttls` function manages the TLS handshake. We use the <a href="https://crates.io/crates/native-tls" rel="nofollow">native-tls</a> crate along with <a href="https://crates.io/crates/tokio-native-tls" rel="nofollow">tokio-native-tls</a> for this purpose.
...
Here's the code to generate a self-signed certificate using the <a href="https://crates.io/crates/openssl" rel="nofollow">openssl</a> crate:
