...
title: Launch Week day X - Flow Builder Copilot
authors: [hugocasa]
tags:
  [
    'Windmill AI',
...
description: "As part of our launch week, we're excited to release a new Windmill AI feature: a copilot for the flow builder."
---
...
As part of our launch week, we're excited to release a new Windmill AI feature: a copilot for the [flow builder](/docs/flows/flow_editor).
...
which offers completion suggestions based on the code you're writing.
...
However, asking GPT-4 to generate a complete workflow is too hard of a problem: it is too difficult to control and would most of the time deviate from the user's intent.
...
When selecting a Windmill Hub script instead of generating a step from scratch, we do not know what input should receive the output of the previous step, therefore we ask GPT-4 to fill in the step's inputs based on the previous step's code and the selected script's inputs.
