...
title: Self-managed GitHub App support
tags: ['Git Sync', 'Enterprise']
image: ./ghes_app_settings.png
description: Self-managed GitHub App support for GitHub.com and GitHub Enterprise Server instances, enabling Git sync without relying on the Windmill-managed GitHub App.
features:
